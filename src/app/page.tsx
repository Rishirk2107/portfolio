...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-800 text-white">
      ...
      <section className="min-h-[85vh] flex items-center section">
        <div className="container mx-auto">
          ...
          >
            ...
            <p className="text-lg sm:text-2xl font-mono text-gray-300 max-w-xl">
            ...
            <div className="flex gap-4 mt-6">
              <Link href="/about" className="btn" prefetch={false}>
                About Me <ArrowRightIcon className="w-5 h-5" />
              </Link>
              <Link href="/projects" className="btn" prefetch={false}>
      ...
      {/* Quick Stats Section */}
      <section className="py-16 section--tight bg-gray-900/40">
